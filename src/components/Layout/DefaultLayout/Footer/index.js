        ...
        <div className={cx('footer--root')}>
            <div className={cx('footer-wrapper')}>
                <div className={cx('footer-nav')}>
                    <div className={cx('footer-nav-main')}>
                        <ul>
                            <p>Company</p>
                            <a target="blank" href="https://www.spotify.com/vn-vi/about-us/contact/">
                                <span>About</span>
                            </a>
                            <a target="blank" href="https://www.lifeatspotify.com/">
                                <span>Jobs</span>
                            </a>
                            <a target="blank" href="https://newsroom.spotify.com/">
                                <span>For the Record</span>
                            </a>
                        </ul>
                        <ul>
                            <p>Communities</p>
                            <a target="blank" href="https://artists.spotify.com/home">
                                <span>For Artists</span>
                            </a>
                            <a target="blank" href="https://developer.spotify.com/">
                                <span>Developers</span>
                            </a>
                            <a target="blank" href="https://ads.spotify.com/en-US/">
                                <span>Advertising</span>
                            </a>
                            <a target="blank" href="https://investors.spotify.com/home/default.aspx">
                                <span>Investors</span>
                            </a>
                            <a target="blank" href="https://spotifyforvendors.com/">
                                <span>Vendors</span>
                            </a>
                        </ul>
                        <ul>
                            <p>Useful Links</p>
                            <a target="blank" href="https://support.spotify.com/vn-vi/">
                                <span>Support</span>
                            </a>
                            <a target="blank" href="https://www.spotify.com/vn-vi/download/windows/">
                    ...
                    <div className={cx('footer-nav-social')}>
                        <div>
                            <a target="blank" href="https://www.instagram.com/spotify/">
                        ...
                        <div>
                            <a target="blank" href="https://x.com/spotify">
                                <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16">
                        ...
                        <div>
                            <a target="blank" href="https://www.facebook.com/SpotifyVietnam/?brand_redir=6243987495#">
                                <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16">
                ...
                <div className={cx('footer-about')}>
                    <div className={cx('footer-about-main')}>
                        <div>
                            <a target="blank" href="https://www.spotify.com/vn-vi/legal/">
                                <span>Legal</span>
                            </a>
                        </div>
                        <div>
                            <a target="blank" href="https://www.spotify.com/vn-vi/safetyandprivacy">
                                <span>Safety & Privacy Center</span>
                            </a>
                        </div>
                        <div>
                            <a target="blank" href="https://www.spotify.com/vn-vi/legal/privacy-policy/">
                                <span>Privacy Policy</span>
                            </a>
                        </div>
                        <div>
                            <a target="blank" href="https://www.spotify.com/vn-vi/legal/cookies-policy/">
                                <span>Cookies</span>
                            </a>
                        </div>
                        <div>
                            <a target="blank" href="https://www.spotify.com/vn-vi/legal/privacy-policy/#s3">
                                <span>About Ads</span>
                            </a>
                        </div>
                        <div>
                            <a target="blank" href="https://www.spotify.com/vn-vi/accessibility">
